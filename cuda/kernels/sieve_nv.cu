...
extern "C" __global__ void __launch_bounds__(1024) sieve(unsigned long long *n59g, unsigned long long S59, int shift, unsigned long long *n_result, unsigned long long *OKOK, int *counter, int offset){

	int idx = (blockIdx.x*blockDim.x + threadIdx.x) + offset;

	__shared__ unsigned long long localOKOK[5898];
